...
<body>
				...
				<div class="row align-items-center">
					<div class="col-xl-8 col-lg-8 col-md-12">
						<div class="page-banner-content wow fadeInLeft">
							<h1 class="sub-page-title">Register</h1>
						...
						<div class="col-xl-6 col-lg-6 col-md-12 order-t-2">
							<div class="customer wow fadeInLeft">
								<div class="section-headding pb-35">
									<span class="sub-title text-uppercase">Register</span>
								...
								<!-- <form>
									...
									<div class="row register-btn-group align-items-center">
								...
								<div class="account-info">
									<p>Already have an account with us <a href="login.html">Login Here</a></p>
								</div>
							</div>
						</div>
	...
	if ($_SERVER["REQUEST_METHOD"] == "POST") {
		...
		$sql = "INSERT INTO usertable (name, email, password, isAdmin) VALUES ('$name', '$email', '$password', 'no')";
